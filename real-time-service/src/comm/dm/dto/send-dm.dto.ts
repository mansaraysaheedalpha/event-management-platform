 ...
 * Contains recipient ID, message text, event scope, and an idempotency key.
 */
export class SendDmDto {
  ...
  /** Event ID to scope the DM conversation - both users must be registered for this event. */
  @IsString()
  @IsNotEmpty()
  eventId: string;
