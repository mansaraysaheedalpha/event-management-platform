...
const documents: Documents = {
    ...
    "\n  query GetEventStats {\n    eventStats {\n      totalEvents\n      upcomingEvents\n      upcomingRegistrations\n    }\n  }\n": types.GetEventStatsDocument,
    "\n  mutation CreateEvent($input: EventCreateInput!) {\n    createEvent(eventIn: $input) {\n      id\n      name\n    }\n  }\n": types.CreateEventDocument,
    "\n  query GetEventById($id: ID!) {\n    event(id: $id) {\n      id\n      name\n      description\n      status\n      startDate\n      endDate\n      isPublic\n    }\n  }\n": types.GetEventByIdDocument,
    "\n  query GetSessionsByEvent($eventId: ID!) {\n    sessionsByEvent(eventId: $eventId) {\n      id\n      title\n      startTime\n      endTime\n      speakers {\n        id\n        name\n      }\n    }\n  }\n": types.GetSessionsByEventDocument,
    "\n  mutation CreateSession($input: SessionCreateInput!) {\n    createSession(sessionIn: $input) {\n      id\n      title\n    }\n  }\n": types.CreateSessionDocument,
    "\n  query GetRegistrationsByEvent($eventId: ID!) {\n    registrationsByEvent(eventId: $eventId) {\n      id\n      status\n      ticketCode\n      checkedInAt\n      user {\n        id\n        first_name\n        last_name\n        email\n      }\n      guestEmail\n      guestName\n    }\n  }\n": types.GetRegistrationsByEventDocument,
    "\n  mutation CreateRegistration(\n    $eventId: String!\n    $registrationIn: RegistrationCreateInput!\n  ) {\n    createRegistration(eventId: $eventId, registrationIn: $registrationIn) {\n      \n      status\n      ticketCode\n      guestEmail\n      guestName\n      user {\n        id\n      }\n    }\n  }\n": types.CreateRegistrationDocument,
